...
import com.example.gameframework.utilities.Logger;
    ...
    /**
     * EKComputerPlayer2 - Algorithm for deciding smart computer player actions
    ...
    public class EKComputerPlayer2 extends GameComputerPlayer {
        ...
        /**
         * EKComputerPlayer2 - the constructor for the computer player
         * @param name - takes in the name of the computer player
         */
        public EKComputerPlayer2(String name) {
            super(name);
        }
         ...
         * will not play a defuse without choice, is more conservative with how  many cards
         * it will play in a given turn
        ...
        protected void receiveInfo(GameInfo info) {
            ...
            if (receive.getPlayerTurn() == playerNum && receive.playerStatus[receive.playerTurn]) {
                ...
                int numCardsToPlay;
                if(receive.deck.get(receive.playerTurn).size() > 4){
                    numCardsToPlay = (int) (Math.random() * 4);
                }else{
                    numCardsToPlay = (int) (Math.random() * receive.deck.get(receive.playerTurn).size());
                }
